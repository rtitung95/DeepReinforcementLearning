...
class MADDPG:
    ...
    def target_act(self, obs_all_agents, noise=0.0):
        ...
        target_actions = [ddpg_agent.target_act(
            obs, noise) for ddpg_agent, obs in zip(self.maddpg_agent,
                                                   obs_all_agents)]
    ...
    def update(self, samples, agent_number, logger):
        ...
        # from target network
        # y = reward of this timestep + discount * Q(st+1,at+1)
        ...
        many of the obs are redundant, and obs[1] contains all useful
        information already
        '''
