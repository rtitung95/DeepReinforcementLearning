...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        # Copy the weights from local to target networks to make sure they share
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        for state, action, reward, nxt_state, done in zip(states, actions, rewards, next_states, dones):
